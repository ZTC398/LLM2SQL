#!/usr/bin/env bash
# Budget-first 2x4090 launch: 500 GRPO steps, no in-training validation.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen25_coder_3b_dual4090_full_500steps_noval}"
