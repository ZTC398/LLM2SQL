#!/usr/bin/env bash
# Budget-first 2x4090 launch: 3000 GRPO steps, no in-training validation.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen25_coder_3b_dual4090_full_3000steps_noval}"
