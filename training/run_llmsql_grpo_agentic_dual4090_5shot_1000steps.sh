#!/usr/bin/env bash
# Base -> 1000-step LLMSQL agentic GRPO on 2x4090 with 5-shot agent prompts.
...
export DATA_DIR="${DATA_DIR:-/root/shared-nvme/rlvr/verl_data/llmsql_agent_5shot}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen25_coder_3b_agentic_5shot_base_1000steps}"
