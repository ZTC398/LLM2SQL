#!/usr/bin/env bash
# Continue from merged step1000 HF weights, keep vLLM sleep mode enabled.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen25_coder_3b_dual4090_fromstep1000_2000steps_sleep}"
